...
public class PaymentModel
{
	...
	private enum payTypeModel
	{
		CREDIT_CARD("PACA"), DIRECT_ACNT("PABK"), INSTALLMENT("PAIN"), RECURRING("PARC"), COUNTER("PAOF"), CHNPAY_OFF(
				"PACF"), CHNPAY_ONL("PACO");

		payTypeModel(String _cd)
		{
			payTypeCd = _cd;
		}
